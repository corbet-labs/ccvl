...
|---|---|---|
| `cvl/imports/` | read-only source-document inbox | private and ignored |
| `cvl/evidence/profile.md` | informal, source-linked working portrait | private and ignored |
| `cvl/evidence/journal.md` | visible interview progress and deferred questions | private and ignored |
| `cvl/general/stations.json` | selected and unassigned station candidates | publishable candidate data |
| `cvl/general/<locale>/cv.typ` | rendered wording and presentation | publishable candidate data |
...
2. **Ingest:** inventory attached, pasted, and `cvl/imports/` sources; preserve
