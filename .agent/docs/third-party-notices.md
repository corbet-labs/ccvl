...
`.agent/typst/fonts/NOTICE.md`; the license text is available in both
`.agent/typst/fonts/OFL-1.1.txt` and `LICENSES/OFL-1.1.txt`.
...
build that binary. Poppler, QPDF, Git, curl, and ripgrep are external tools
