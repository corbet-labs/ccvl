...
toolchain and compiled `ccvl` binary below `.cache/ccvl/`, then runs the complete
...
non-Archivo PDF font as a failure. The checked-in Visual Studio Code and Zed
Tinymist settings point editor previews at the same bundled font files.
